...
import DoctorRegForm from "../RegisterationFile/DoctorRegForm";
                    ...
                    (<Paper className={classes.paper}>
                        ...
                        >
                            ...
                            <Button
                                ...
                                type="submit"
                                onClick={this.handleDoctorSubmit}
                            >
                                Join
                            </Button>
                        </form>
                        ...
                        <Typography sx={{ cursor: 'pointer' }} onClick={this.createAcc}>
                            Create Account
                        </Typography>
                    </Paper>)
                    :
...
export default withStyles(register)(DoctorLogin);
